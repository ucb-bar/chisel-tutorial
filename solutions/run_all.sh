...
sbt "run SingleEvenFilter --backend c --targetDir ../emulator --compile --test --genHarness"
sbt "run VecShiftRegister --backend c --targetDir ../emulator --compile --test --genHarness"
sbt "run VecShiftRegisterSimple --backend c --targetDir ../emulator --compile --test --genHarness"
sbt "run VecShiftRegisterParam --backend c --targetDir ../emulator --compile --test --genHarness"
...
sbt "run VendingMachine --backend c --targetDir ../emulator --compile --test --genHarness"
sbt "run VendingMachineSwitch --backend c --targetDir ../emulator --compile --test --genHarness"
